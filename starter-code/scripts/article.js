...
Article.prototype.toHtml = function() {
  ...
  let bob = document.getElementById('articles');
  let completeTemplate = document.createElement('div');
  console.log(this, 'is this');
  completeTemplate.innerHTML = template(this);
  console.log(completeTemplate, 'is complete template')
  bob.appendChild(completeTemplate);
